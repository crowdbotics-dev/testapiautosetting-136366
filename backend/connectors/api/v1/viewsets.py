...
class Testconnectors136366ViewSet(BaseConnectorViewSet):
    PASSWORD = settings.CONNECTOR_TESTCONNECTORS136366_PASSWORD
    USERNAME = settings.CONNECTOR_TESTCONNECTORS136366_USERNAME
    BASE_URL = "https://devstringx.com"
    AUTH_TYPE = "basic"
    IDENTIFIER = "CONNECTOR_TESTCONNECTORS136366"
